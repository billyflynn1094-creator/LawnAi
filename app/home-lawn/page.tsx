  ...
  const handleFindPros = async () => {
    ...
    try {
      ...
      if (!data.pros || data.pros.length === 0) {
        setProsError('No lawn care specialists found nearby. Try expanding your search on Google Maps.');
      } else {
                  ...
                  >
                    ...
                    {prosLoading && (
                      <div className="bg-white py-6 flex flex-col items-center gap-2">
                        ...
                        <p className="text-xs" style={{ color: BRAND.textMuted }}>Searching nearby specialists…</p>
                      </div>
                    )}
                    ...
                    {!prosLoading && localPros.length > 0 && (
                      <div className="bg-white divide-y" style={{ borderColor: BRAND.border }}>
                        {analysis?.identified?.primary && (
                          <div className="px-4 py-2.5" style={{ backgroundColor: 'rgba(249,99,2,0.06)' }}>
