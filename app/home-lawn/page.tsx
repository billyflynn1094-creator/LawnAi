...
import { RotateCcw, MapPin, Navigation, Home, ExternalLink } from 'lucide-react';
        ...
        <div className="max-w-lg mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col leading-none ml-1">
              <span className="font-bold text-[18px] text-white tracking-tight">Home<span className="font-black">Lawn</span></span>
          ...
          <div className="flex flex-col gap-3">
            {capturedImage && (
              <div className="rounded-2xl overflow-hidden border" style={{ borderColor: BRAND.borderAccent }}>
                ...
                <img src={b64Src(capturedImage)} alt="Captured lawn" className="w-full max-h-56 object-cover" />
              </div>
            )}
          ...
          <div id="results">
            {capturedImage && (
              <div className="rounded-2xl overflow-hidden mb-4 relative border" style={{ borderColor: BRAND.borderAccent }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={b64Src(capturedImage)} alt="Analyzed lawn" className="w-full max-h-64 object-cover" />
            ...
            {/* ---- Request a Home Depot Pro section ---- */}
            <div className="mt-5">
              <a
                href="https://www.homedepot.com/services/c/g/67fe2409a"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center gap-2 py-3.5 px-4 rounded-2xl font-semibold text-sm transition-all hover:opacity-90"
                style={{ backgroundColor: BRAND.primary, color: '#fff' }}
              >
                <MapPin size={15} /> Request a Lawn Care Pro via Home Depot
                <ExternalLink size={13} />
              </a>
              <p className="text-center text-[11px] mt-2" style={{ color: BRAND.textMuted }}>
                Opens Home Depot&apos;s local installed-services request — they&apos;ll match you with a vetted pro in your area.
              </p>
            </div>
            {/* ---- End Request a Home Depot Pro section ---- */}
